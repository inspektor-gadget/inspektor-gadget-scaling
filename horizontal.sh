...
while getopts "g:c:n:o:h" option; do
	...
	h|\?)
		...
		echo -e "\t-c: The given string will be used as cluster name, ${kubernetes_cluster} by default." 1>&2
		echo -e "\t-n: The given number will be used as node size, 16 cores by default." 1>&2
